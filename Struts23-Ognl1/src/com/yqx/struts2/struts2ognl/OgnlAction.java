...
public class OgnlAction extends ActionSupport {
	...
	private List<Person> persons = new ArrayList<Person>();
	 ...
	 private void initData(){
		 ...
		 //Address address2=new Address("中国", "上海","浦东区111号");
		 Address address2=new Address("中国", "上海",	"浦东区111号");
		 Address address3=new Address("中国", "北京","朝阳区121号");
		 ...
		 Person person1=new Person("张三",33,33333,address1,alias1,email1,phone1);
		 Person person2=new Person("李四",44,44444,address2,alias2,email2,phone2);
		 Person person3=new Person("王五",55,55555,address3,alias3,email3,phone3);
