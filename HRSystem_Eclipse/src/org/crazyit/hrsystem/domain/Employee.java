...
public class Employee implements Serializable {
	...
	// 员工国籍
	@Column(name = "emp_shengao", nullable = false, length = 50, unique = true)
	private double shengao;
	// 员工年龄
	@Column(name = "emp_tizhong", nullable = false)
	...
	// 初始化全部成员变量的构造器
	public Employee(Integer id, String name, String pass, double salary , double shengao , double tizhong, Manager manager, Set<Attend> attends,
