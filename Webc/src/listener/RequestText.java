...
/**
 * Application Lifecycle Listener implementation class RequestText
 *
 */
@WebListener
public class RequestText implements ServletRequestListener, ServletRequestAttributeListener, AsyncListener {
